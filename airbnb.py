...
st.set_page_config(page_title="AirBnb-Analysis by ABINAYA S.Y.", page_icon=":bar_chart:", layout="wide")
...
SELECT = option_menu(
    menu_title=None,
    options=["Home","About", "Explore Data", "Contact"],
    icons=["house", "bar-chart","at", ],
    default_index=2,
    orientation="horizontal",
    styles={"container": {"padding": "0!important", "background-color": "white", "size": "cover", "width": "100", "height": "100 "},
            "icon": {"color": "blue", "font-size": "15px"},

            "nav-link": {"font-size": "15px", "text-align": "center", "margin": "-2px", "--hover-color": "#6F36AD"},
...
if SELECT == "Home":
 ...
 st.header(':orange[SKILLS TAKE AWAY FROM THIS PROJECT ::]')
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir=("c:/Users/abine/Downloads/Airbnb NYC 2019.csv")
    df = pd.read_csv("c:/Users/abine/Downloads/Airbnb NYC 2019.csv")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Abinaya S.Y."}')
    mail = (f'{"Mail :"}  {"abinayayadavamurthy2202@gmail.com"}')
    Batch = (f'{"Batch Code :"}  {"MDTM017"}')
    description = "An Aspiring -  DATA-ANALYST..!"
    social_media = {"GITHUB":"https://github.com/Abinaya2202."
                    }

    col1, col2 = st.columns(2)
    
    col1.image(Image.open("c:/Users/abine/OneDrive/Desktop/airbnb.im.jpg"),width=500)
    
    col1.image(Image.open("c:/Users/abine/OneDrive/Desktop/GUVI .jpg"), width=500)
